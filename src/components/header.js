...
<Link to="./artificial_intelligence" className={headerStyles.pages}>Artificial inteligence</Link> 
</DropdownItem>
<DropdownItem className={headerStyles.options}>
<Link to="./cloud_native" className={headerStyles.pages}>Cloud Native and Mobile Web</Link> 
</DropdownItem>
<DropdownItem className={headerStyles.options}>
<Link to="./blockchain" className={headerStyles.pages}>Blockchain</Link>
</DropdownItem>
<DropdownItem className={headerStyles.options}>
<Link to="./internet_of_things" className={headerStyles.pages}>Internet Of Things</Link> 
</DropdownItem>
</DropdownMenu>
</UncontrolledDropdown>
<UncontrolledDropdown nav inNavbar>
...
<DropdownItem className={headerStyles.options}>
<Link to="./about" className={headerStyles.pages}>The President</Link>
</DropdownItem>
<DropdownItem className={headerStyles.options}>
<Link to="./managementComittee" className={headerStyles.pages}>Management Committie</Link>
</DropdownItem>
</DropdownMenu>
</UncontrolledDropdown>
